...
const Navbar = () => {
  ...
  const handleLogout = () => {
    try {
      // Clear local/session storage if you use them
      localStorage.clear();
      ...
      const loginRoute = "/login"; // or whatever your login route is
      window.history.replaceState(null, "", loginRoute);

      // Navigate to login and reload the app to clear in-memory state
